...
#ifndef THEMIS_STATE_MSGS__MSG__DETAIL__TH_JOINT_STATE__TRAITS_HPP_
#define THEMIS_STATE_MSGS__MSG__DETAIL__TH_JOINT_STATE__TRAITS_HPP_
...
// Member 'left_hand'
// Member 'right_hand'
#include "themis_state_msgs/msg/detail/joint_array__traits.hpp"
...
inline std::string to_yaml(const THJointState & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const themis_state_msgs::msg::THJointState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const themis_state_msgs::msg::THJointState & msg)
{
  return themis_state_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<themis_state_msgs::msg::THJointState>()
{
  return "themis_state_msgs::msg::THJointState";
}

template<>
inline const char * name<themis_state_msgs::msg::THJointState>()
{
  return "themis_state_msgs/msg/THJointState";
}

template<>
struct has_fixed_size<themis_state_msgs::msg::THJointState>
  : std::integral_constant<bool, has_fixed_size<themis_state_msgs::msg::JointArray>::value> {};

template<>
struct has_bounded_size<themis_state_msgs::msg::THJointState>
  : std::integral_constant<bool, has_bounded_size<themis_state_msgs::msg::JointArray>::value> {};

template<>
struct is_message<themis_state_msgs::msg::THJointState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // THEMIS_STATE_MSGS__MSG__DETAIL__TH_JOINT_STATE__TRAITS_HPP_
