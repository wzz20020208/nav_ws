...
themis_state_msgs__msg__Foot__create()
{
  ...
  themis_state_msgs__msg__Foot * msg = (themis_state_msgs__msg__Foot *)allocator.allocate(sizeof(themis_state_msgs__msg__Foot), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(themis_state_msgs__msg__Foot));
  bool success = themis_state_msgs__msg__Foot__init(msg);
  if (!success) {
...
themis_state_msgs__msg__Foot__destroy(themis_state_msgs__msg__Foot * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    themis_state_msgs__msg__Foot__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
themis_state_msgs__msg__Foot__Sequence__init(themis_state_msgs__msg__Foot__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  themis_state_msgs__msg__Foot * data = NULL;

  if (size) {
    data = (themis_state_msgs__msg__Foot *)allocator.zero_allocate(size, sizeof(themis_state_msgs__msg__Foot), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = themis_state_msgs__msg__Foot__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        themis_state_msgs__msg__Foot__fini(&data[i - 1]);
      }
...
themis_state_msgs__msg__Foot__Sequence__fini(themis_state_msgs__msg__Foot__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      themis_state_msgs__msg__Foot__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  themis_state_msgs__msg__Foot__Sequence * array = (themis_state_msgs__msg__Foot__Sequence *)allocator.allocate(sizeof(themis_state_msgs__msg__Foot__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = themis_state_msgs__msg__Foot__Sequence__init(array, size);
  if (!success) {
...
themis_state_msgs__msg__Foot__Sequence__destroy(themis_state_msgs__msg__Foot__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    themis_state_msgs__msg__Foot__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
themis_state_msgs__msg__Foot__Sequence__are_equal(const themis_state_msgs__msg__Foot__Sequence * lhs, const themis_state_msgs__msg__Foot__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!themis_state_msgs__msg__Foot__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  themis_state_msgs__msg__Foot__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(themis_state_msgs__msg__Foot);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    themis_state_msgs__msg__Foot * data =
      (themis_state_msgs__msg__Foot *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!themis_state_msgs__msg__Foot__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          themis_state_msgs__msg__Foot__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!themis_state_msgs__msg__Foot__copy(
