...
#include "themis_state_msgs/msg/detail/joint_array__rosidl_typesupport_fastrtps_c.h"
...
using _JointArray__ros_msg_type = themis_state_msgs__msg__JointArray;
  ...
  void * untyped_ros_message)
{
  ...
  _JointArray__ros_msg_type * ros_message = static_cast<_JointArray__ros_msg_type *>(untyped_ros_message);
  // Field name: position
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
static uint32_t _JointArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_themis_state_msgs__msg__JointArray(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = themis_state_msgs__msg__JointArray;
    is_plain =
      (
...
static size_t _JointArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_themis_state_msgs__msg__JointArray(
