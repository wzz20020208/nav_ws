...
export declare function createTgz(dir: string, onError: (error: any) => void): NodeJS.ReadableStream;
export declare function createGitHubStringSetGetter(repoPath: string, fallbackPath: string): () => Promise<ReadonlySet<string>>;
export {};
