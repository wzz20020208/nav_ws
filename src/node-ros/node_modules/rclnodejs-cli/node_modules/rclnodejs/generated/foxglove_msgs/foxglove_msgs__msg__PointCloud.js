...
const PointCloudRefStruct = StructType({
  ...
  point_stride: primitiveTypes.uint32,
...
class PointCloudWrapper {
  constructor(other) {
    ...
    if (typeof other === 'object' && other._refObject) {
      ...
      this._point_strideIntialized = true;
  ...
  _initMembers() {
    ...
    this._point_strideIntialized = false;
    this._wrapperFields.fields = PackedElementFieldWrapper.createArray();
    this._wrapperFields.data = UInt8Wrapper.createArray();
  }
  ...
  freeze(own = false, checkConsistency = false) {
    if (checkConsistency) {
      if (!this._frame_idIntialized) {
        throw new TypeError('Invalid argument: frame_id in PointCloud');
      }
      if (!this._point_strideIntialized) {
        throw new TypeError('Invalid argument: point_stride in PointCloud');
      }
    }
  ...
  deserialize(refObject) {
    ...
    this._point_strideIntialized = true;
    this._refObject.point_stride = refObject.point_stride;
  ...
  static type() {
    return {pkgName: 'foxglove_msgs', subFolder: 'msg', interfaceName: 'PointCloud'};
  }
  static isPrimitive() {
    return false;
  }
  ...
  get point_stride() {
    ...
    return this._refObject.point_stride;
  }
  set point_stride(value) {
    this._point_strideIntialized = true;
    this._refObject.point_stride = value;
  }
  get fields() {
