...
class ImuWrapper {
  ...
  freeze(own) {
    ...
    this._wrapperFields.orientation.freeze(own);
    this._refObject.orientation = this._wrapperFields.orientation.refObject;
    this._refObject.orientation_covariance = Array.from(this._wrapperFields.orientation_covariance.data);
    this._wrapperFields.angular_velocity.freeze(own);
    this._refObject.angular_velocity = this._wrapperFields.angular_velocity.refObject;
    this._refObject.angular_velocity_covariance = Array.from(this._wrapperFields.angular_velocity_covariance.data);
    this._wrapperFields.linear_acceleration.freeze(own);
    this._refObject.linear_acceleration = this._wrapperFields.linear_acceleration.refObject;
    this._refObject.linear_acceleration_covariance = Array.from(this._wrapperFields.linear_acceleration_covariance.data);
  }
  serialize() {
    this.freeze(/*own=*/false);
    return this._refObject.ref();
