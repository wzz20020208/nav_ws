...
const UVCoordinateWrapper = require('../../generated/visualization_msgs/visualization_msgs__msg__UVCoordinate.js');
const MeshFileWrapper = require('../../generated/visualization_msgs/visualization_msgs__msg__MeshFile.js');
const MarkerRefStruct = StructType({
  ...
  texture_resource: primitiveTypes.string,
  texture: CompressedImageWrapper.refObjectType,
  uv_coordinates: UVCoordinateWrapper.refObjectArrayType,
  text: primitiveTypes.string,
  mesh_resource: primitiveTypes.string,
  mesh_file: MeshFileWrapper.refObjectType,
...
class MarkerWrapper {
  constructor(other) {
    ...
    this._setDefaults();
     if (typeof other === 'object' && other._refObject) {
      ...
      this._wrapperFields.texture_resource =  new StringWrapper(other._wrapperFields.texture_resource);
      this._wrapperFields.texture =  new CompressedImageWrapper(other._wrapperFields.texture);
      this._wrapperFields.uv_coordinates = UVCoordinateWrapper.createArray();
      this._wrapperFields.uv_coordinates.copy(other._wrapperFields.uv_coordinates);
      ...
      this._wrapperFields.mesh_file =  new MeshFileWrapper(other._wrapperFields.mesh_file);
  ...
  _initialize() {
    ...
    this._wrapperFields.points = PointWrapper.createArray();
    this._wrapperFields.colors = ColorRGBAWrapper.createArray();
    this._wrapperFields.texture_resource = new StringWrapper();
    this._wrapperFields.texture = new CompressedImageWrapper();
    this._wrapperFields.uv_coordinates = UVCoordinateWrapper.createArray();
    this._wrapperFields.text = new StringWrapper();
    this._wrapperFields.mesh_resource = new StringWrapper();
    this._wrapperFields.mesh_file = new MeshFileWrapper();
  }
  ...
  freeze(own) {
    ...
    if (own) {
      this._wrapperFields.ns.freeze(own);
    }
    ...
    this._wrapperFields.scale.freeze(own);
    ...
    this._wrapperFields.lifetime.freeze(own);
    ...
    if (own) {
      this._wrapperFields.colors.fill([]);
    }
    this._wrapperFields.colors.freeze(own);
    this._refObject.colors = this._wrapperFields.colors.refObject;
    if (own) {
      this._wrapperFields.texture_resource.freeze(own);
    }
    this._refObject.texture_resource = this._wrapperFields.texture_resource.refObject;
    this._wrapperFields.texture.freeze(own);
    this._refObject.texture = this._wrapperFields.texture.refObject;
    if (own) {
      this._wrapperFields.uv_coordinates.fill([]);
    }
    this._wrapperFields.uv_coordinates.freeze(own);
    this._refObject.uv_coordinates = this._wrapperFields.uv_coordinates.refObject;
    if (own) {
      this._wrapperFields.text.freeze(own);
    }
    this._refObject.text = this._wrapperFields.text.refObject;
    if (own) {
      this._wrapperFields.mesh_resource.freeze(own);
    }
    this._refObject.mesh_resource = this._wrapperFields.mesh_resource.refObject;
    this._wrapperFields.mesh_file.freeze(own);
    this._refObject.mesh_file = this._wrapperFields.mesh_file.refObject;
  }
  serialize() {
    this.freeze(/*own=*/false);
    return this._refObject.ref();
  ...
  deserialize(refObject) {
    ...
    this._wrapperFields.texture_resource.data = refObject.texture_resource.data;
    this._wrapperFields.texture.copyRefObject(refObject.texture);
    this._wrapperFields.uv_coordinates.copyRefObject(refObject.uv_coordinates);
    this._wrapperFields.text.data = refObject.text.data;
    this._wrapperFields.mesh_resource.data = refObject.mesh_resource.data;
    this._wrapperFields.mesh_file.copyRefObject(refObject.mesh_file);
  ...
  static freeStruct(refObject) {
    ...
    StringWrapper.freeStruct(refObject.texture_resource);
    CompressedImageWrapper.freeStruct(refObject.texture);
    if (refObject.uv_coordinates.size != 0) {
      UVCoordinateWrapper.ArrayType.freeArray(refObject.uv_coordinates);
      if (!UVCoordinateWrapper.ArrayType.useTypedArray) {
        deallocator.freeStructMember(refObject.uv_coordinates, UVCoordinateWrapper.refObjectArrayType, 'data');
      }
    }
    StringWrapper.freeStruct(refObject.text);
    StringWrapper.freeStruct(refObject.mesh_resource);
    MeshFileWrapper.freeStruct(refObject.mesh_file);
  }
  ...
  get texture_resource() {
    return this._wrapperFields.texture_resource.data;
  }
  set texture_resource(value) {
    this._wrapperFields.texture_resource.data = value;
  }
  get texture() {
    return this._wrapperFields.texture;
  }
  set texture(value) {
    if (value instanceof CompressedImageWrapper) {
      this._wrapperFields.texture.copy(value);
    } else {
      this._wrapperFields.texture.copy(new CompressedImageWrapper(value));
    }
  }
  get uv_coordinates() {
    return this._wrapperFields.uv_coordinates;
  }
  set uv_coordinates(value) {
    this._wrapperFields.uv_coordinates.fill(value);
  }
  get text() {
  ...
  get mesh_file() {
    return this._wrapperFields.mesh_file;
  }
  set mesh_file(value) {
    if (value instanceof MeshFileWrapper) {
      this._wrapperFields.mesh_file.copy(value);
    } else {
      this._wrapperFields.mesh_file.copy(new MeshFileWrapper(value));
    }
  }
  ...
  copyRefObject(refObject) {
    ...
    this._wrapperFields.texture_resource.copyRefObject(this._refObject.texture_resource);
    this._wrapperFields.texture.copyRefObject(this._refObject.texture);
    this._wrapperFields.uv_coordinates.copyRefObject(this._refObject.uv_coordinates);
    ...
    this._wrapperFields.mesh_file.copyRefObject(this._refObject.mesh_file);
  }
  copy(other) {
    this._refObject = new MarkerRefStruct(other._refObject.toObject());
    ...
    this._wrapperFields.points.copy(other._wrapperFields.points);
    this._wrapperFields.colors.copy(other._wrapperFields.colors);
    this._wrapperFields.texture_resource.copy(other._wrapperFields.texture_resource);
    this._wrapperFields.texture.copy(other._wrapperFields.texture);
    this._wrapperFields.uv_coordinates.copy(other._wrapperFields.uv_coordinates);
