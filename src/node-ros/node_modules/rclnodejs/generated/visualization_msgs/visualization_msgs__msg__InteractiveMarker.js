...
class InteractiveMarkerWrapper {
  ...
  freeze(own) {
    ...
    if (own) {
      this._wrapperFields.menu_entries.fill([]);
    }
    this._wrapperFields.menu_entries.freeze(own);
    this._refObject.menu_entries = this._wrapperFields.menu_entries.refObject;
    if (own) {
      this._wrapperFields.controls.fill([]);
    }
    this._wrapperFields.controls.freeze(own);
