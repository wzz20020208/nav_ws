...
#include "nav2_custom_plugins_parallel/is_progress_diagnosis.hpp"
...
BT_REGISTER_NODES(factory)
{
  ...
  factory.registerBuilder(
    BT::CreateManifest<nav2_custom_plugins_parallel::IsProgressDiagnosis>(
      "IsProgressDiagnosis", ports),
    BT::CreateBuilder<nav2_custom_plugins_parallel::IsProgressDiagnosis>());
}
